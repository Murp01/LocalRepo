...
public class assertAllPrimaryNaveTitles {

	public static void main(String[] args) {
		/* TODO Click on all primary nav items using following-sibling.
		 */
		...
		/*improvements
		 * Use a variable that iterates for the [1] in the relative xpath
		 * Use a data store for the urls
		 * Instead of stopping upon a failed url it needs to carry on
		 * create another page for a different language
		 */
